   ...
   chart.render()
     ...
     /*setTimeout(function() {
      ...
      for (var i = 0;i<data.length;i++){
        ...
        labels3.push(data[i].holdingCases)
...
var button7 = document.getElementById('myChart7tab').addEventListener('click', function(){
   ...
   chart.render()
     ...
     /*setTimeout(function() {
      ...
      let labels4=[]
      for (var i = 0;i<data.length;i++){
        labels3.push({"x":data[i].name,"y":data[i].holdingCases})
        // labels3.push(data[i].qty)
         }
...
var buttonR7 = document.getElementById('myChart7tabR').addEventListener('click', function(){
...
var buttonR8 = document.getElementById('myChart8tabR').addEventListener('click', function(){
...
var buttonR9 = document.getElementById('myChart9tabR').addEventListener('click', function(){
