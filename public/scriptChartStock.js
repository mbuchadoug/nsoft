...
var buttonR1 = document.getElementById('myChart5tabR').addEventListener('click', function(){
   ...
   chart.render()
     ...
     /*setTimeout(function() {
      ...
      let labels4=[]
      for (var i = 0;i<data.length;i++){
        labels3.push({"x":data[i].product,"y":data[i].quantity})
        // labels3.push(data[i].qty)
         }
...
///////////
var buttonR6 = document.getElementById('myChart66tabR').addEventListener('click', function(){
    ...
    let labelsX=[]
      ...
      //contractQty
     const  element = document.getElementById('myChart66R');
...
//////////////
var buttonR7 = document.getElementById('myChart77tabR').addEventListener('click', function(){
  ...
  let labelsX=[]
    ...
    //contractQty
   const  element = document.getElementById('myChart77R');
...
/////////////
var buttonR8 = document.getElementById('myChart88tabR').addEventListener('click', function(){
  ...
  let labelsX=[]
    ...
    //contractQty
   const  element = document.getElementById('myChart88R');
