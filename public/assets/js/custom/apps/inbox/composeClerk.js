...
code2:code2
    ...
    url: "/clerk/dataX",
    success: function(data) {
      window.location.href = "http://localhost:9500/clerk/compose"
      alert('Message Sent')
    }
  })
