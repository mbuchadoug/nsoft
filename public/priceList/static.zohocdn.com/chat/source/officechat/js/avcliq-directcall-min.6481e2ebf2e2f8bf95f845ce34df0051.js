...
MediaCallUI = {
    ...
    startCall: function(e, t, i, a, n) {
        ...
        var l = {
            ...
            success: function(e) {
                var t, i;
                t = e.call_id, i = MediaCallConstants.request.status.SUCCESS, MediaCallImpl.updateAPIResponseTimeInLog(t, "/call", MediaCallConstants.request.method.POST, i, s), a(e)
            },
            error: function(e) {
                n(e)
            }
            ...
            if (i && i.getId() === e)
                if (t.action === WebRTCPeerConnectionConstants.optimizations.opr.SET) switch (t.level) {
                    case 1:
                        ...
                        break;
                    case 2:
                        MediaCallImpl.handleVideoMute(e), i.writeToLog("Level 2 optimization triggered - " + t), MediaUtil.showLiveTrackingNotification("mediacall_container", "bandwidth.poor.videomuted");
                        break;
                    case 3:
                    ...
                    switch (t.level) {
                        case 1:
                            ...
                            break;
                        case 2:
                            i.writeToLog("Level 2 optimization reset - " + t), MediaUtil.showLiveTrackingNotification("mediacall_container", "bandwidth.poor.videounmute", a);
                            break;
                        case 3:
