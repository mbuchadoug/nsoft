    ...
    return {
        ...
        getFiles: function() {
            ...
            if (iscdnenabled && (i.cssstaticfile = "/salesiq/styles/embedtheme" + t.theme + "_" + cssjslist[i.cssstaticfile] + "_.css", i.jsstaticfile = "/salesiq/js/siqchatwindow" + t.theme + "_" + cssjslist[i.jsstaticfile] + "_.js"), $ZSIQChatWindow.isNewHeader()) {
                ...
                i.cssstaticfile = t.isRtlLang ? "/salesiq/styles/embedrtl_Tzps9SxqTIEwNjusYgexXR7OKAqYoZX-nL6OHhZtWptHAFRjvjS1Q17pAATkAibp_.css" : "/salesiq/styles/newembedtheme_Y_v5dwYhfbfaroeLcDotURzN3ARU9SYCZgH_PBeFNG_kfuzQxGOto5O2D9JOMk38_.css", i.jsstaticfile = g ? "/salesiq/js/siqnewchatwindow1_r6l_f2yF5GavMIkquNwbIs7HaC1emk_Zujr040C4ZojQBr0DklbVGeeH4GUrmqpR_.js" : "/salesiq/js/siqnewchatwindow_1ZU5FFT8W4ZyT8kvsucG-vbD0Z-s30-Vy_1nCRAnkLLkbopnEfTNfdgaII7BfZDu_.js"
            }
            ...
            if (t.ucomp) {
                var u = $zohosq.nonce ? 'nonce ="' + $zohosq.nonce + '"' : "",
                    p = n.jscdnstaticserver + "/salesiq/js/embedmedia-rtc_ou_oPkGk926NJnV0-ruXVm0AQcLfue0nbkmQr3V3yxNGjtqaM9jBrfkvHFexUCoL_.js";
