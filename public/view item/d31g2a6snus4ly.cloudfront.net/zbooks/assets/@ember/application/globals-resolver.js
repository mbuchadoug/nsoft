        ...
        DefaultResolver = /*#__PURE__*/ function(_EmberObject) {
                ...
                if (false /* DEBUG */ ) {
                    ...
                    if (resolved) {
                        ...
                        if (validationAttributes) {
                            ...
                            (false && !(Boolean(resolved[factoryFlag])) && (0, _debug.assert)("Expected " + parsedName.fullName + " to resolve to an " + expectedType + " but " + ("instead it was " + (0, _utils.getName)(resolved) + "."), Boolean(resolved[factoryFlag])));
                        }
                    }
                }
                return resolved;
            ...
            */
            ...
            _proto.makeToString = function makeToString(factory) {
                var _factory$name;
                return typeof factory === 'string' ? factory : (_factory$name = factory.name) != null ? _factory$name : '(unknown class)';
            }
            /**
