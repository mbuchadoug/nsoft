        ...
        if (this._packetLossObj.audio.length === this._networkAdapterConfiguration.total_samples_for_calculation) {
            ...
            if (e > this._networkAdapterConfiguration.packet_loss_metric.avg) {
                if (this._packetLossObj.video.length > 0) {
                    ...
                    if (this._appliedOptimizationLevels.level1) this._appliedOptimizationLevels.level2 || (this._appliedOptimizationLevels.level2 = WebRTCPeerConnectionConstants.optimizations.level2, this._networkAdapterActionCB(this._id, {
                        level: 2,
                        ...
                        this._appliedOptimizationLevels.level1 = WebRTCPeerConnectionConstants.optimizations.level1, this._networkAdapterActionCB(this._id, {
                            level: 1,
                            action: WebRTCPeerConnectionConstants.optimizations.opr.SET,
                            bitrate: i,
                    ...
                    if (!this._appliedOptimizationLevels.level3) {
                        ...
                        this._appliedOptimizationLevels.level3 = WebRTCPeerConnectionConstants.optimizations.level3, this._networkAdapterActionCB(this._id, {
                            level: 3,
                            action: WebRTCPeerConnectionConstants.optimizations.opr.SET,
                            bitrate: i,
                    ...
                    this._appliedOptimizationLevels.level4 = WebRTCPeerConnectionConstants.optimizations.level4, this._networkAdapterActionCB(this._id, {
                        level: 4,
                        action: WebRTCPeerConnectionConstants.optimizations.opr.SET,
                        bitrate: i,
    ...
    var e = [],
        ...
        b = s => {
            ...
            MediaAPI.submitFeedback(r, s, (function() {
                ...
                })), P(e.find("#feedback_success_info")))) : (ZCMediaDomUtil.removeHtmlAndAddTickMark(s), setTimeout(() => {
                    k()
                }, 500))
            }), (function() {}))
        },
        ...
        A = e => {
            P(i), i.on("keyup keydown focus", "[feedbackinput]", e => {
