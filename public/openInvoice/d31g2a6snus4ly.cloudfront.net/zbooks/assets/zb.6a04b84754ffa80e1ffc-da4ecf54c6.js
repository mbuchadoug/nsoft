        ...
        kigUS72jsE: (t, e, i) => {
            ...
            const h = n().extend({
                ...
                sampleFilePath: (0, s.computed)("model.{prefixPath,amount_format,isBankStatementImport,editions}", "fileExtension", "fileName", "appViewService.filePrefix", "appMeta.is_books", (function() {
                    ...
                    (0, r.isPresent)(s) && (0, r.isPresent)(a) && s.includes(a) && ("es-mx" === a && (a = o ? "mx" : ""), a && (i = "".concat(a, "/").concat(i)));
                    let d = this.model.entity_constant;
                    if (d.startsWith("cm_")) {
                        let t = "/samplefile/download?entity=".concat(d, "&accept=csv");
                ...
                sampleXlsFilePath: (0, s.computed)("model.{prefixPath,sample_file_name_xls}", "currentOrg.{isGermanVersion,isMexicanVersion}", "appMeta.is_books", (function() {
                    ...
                    let s, a = "".concat(this.appViewService.filePrefix).concat(this.model.prefixPath),
                        d = this.get("model.specific_xls_editions") || this.get("model.editions");
                    return (0, r.isPresent)(d) && (this.get("currentOrg.isUSVersion") && d.includes("us") ? s = "us/".concat(t) : this.get("currentOrg.isUKVersion") && d.includes("uk") ? s = "uk/".concat(t) : this.get("currentOrg.isCanadaVersion") && d.includes("ca") ? s = "ca/".concat(t) : this.get("currentOrg.isAUVersion") && d.includes("au") ? s = "au/".concat(t) : this.get("currentOrg.isIndiaVersion") && d.includes("in") ? s = "in/".concat(t) : this.get("currentOrg.isUAEVersion") && d.includes("ae") ? s = "ae/".concat(t) : this.get("currentOrg.isSAVersion") && d.includes("sa") ? s = "sa/".concat(t) : this.get("currentOrg.isBHVersion") && d.includes("bh") ? s = "bh/".concat(t) : e && d.includes("de") ? s = "de/".concat(t) : this.get("currentOrg.isGlobalVersion") && d.includes("global") ? s = t : n && d.includes("es-mx") && (s = "mx/".concat(t))), !this.get("model.specific_xls_editions") || s ? a + (s || t) : void 0
                })),
                ...
                needPdfInstitutionUpdate: (0, s.computed)("isPDFImportAllowed", "model.account.pdf_institution_id", "currentOrg.isPDFImportEnabled", (function() {
                    return this.isPDFImportAllowed && this.get("model.account") && (this.currentOrg.isPDFImportEnabled || (0, r.isEmpty)(this.get("model.account.pdf_institution_id")))
                })),
                ...
                actions: {
                    ...
                    importFile() {
                        this.get("model.isPasswordProtected") && (0, r.isEmpty)(this.modulus) ? this.store.getJSON("/bankaccounts/import/encryptionkey").then((t => {
                            this.setProperties({
                    ...
                    _importFile() {
                        ...
                        return this.set("model.isUploading", !0), i.sendRequest(a, r).then((t => {
                            let {
                                data: e = {}
                            } = t;
                    ...
                    convertXMLToJSON() {
                        ...
                        let {
                            ...
                            organization_id: e,
                            entity: o
                        }, a = i && "bill" === o, r = m.default.constructUrlParam("/einvoice/import", s), d = new FormData;
                        d.append("importfile", n), this.set("isXMLImportLoading", !0), this.store.ajax(r, {
                            type: "POST",
                            data: d
                        }).then((function() {
                            ...
                            t.send("closeWizardAndReDirect"), a ? t.router.transitionTo(n, {
                                queryParams: {
                                    einvoice_import_id: i
                                }
                            }) : t.notificationService.success(o)
                        })).catch((function() {
                            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                {
                                    message: i
