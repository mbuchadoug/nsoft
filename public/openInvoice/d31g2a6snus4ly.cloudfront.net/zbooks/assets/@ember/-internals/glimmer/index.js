define("@ember/-internals/glimmer/index", ["exports", "ember-babel", "@ember/polyfills", "@glimmer/opcode-compiler", "@ember/-internals/metal", "@ember/debug", "@ember/deprecated-features", "@ember/string", "@glimmer/reference", "@glimmer/validator", "@ember/-internals/views", "@glimmer/destroyable", "@glimmer/manager", "@ember/-internals/utils", "@ember/instrumentation", "@ember/runloop", "@glimmer/util", "@ember/-internals/owner", "@glimmer/runtime", "@ember/-internals/runtime", "@ember/-internals/browser-environment", "@ember/engine", "@ember/service", "@ember/object", "@ember/-internals/environment", "@ember/-internals/container", "@glimmer/node", "@ember/-internals/glimmer", "@glimmer/global-context", "@ember/-internals/routing", "@ember/error", "@glimmer/program", "rsvp"], function(_exports, _emberBabel, _polyfills, _opcodeCompiler, _metal, _debug, _deprecatedFeatures, _string, _reference, _validator, _views, _destroyable, _manager2, _utils, _instrumentation, _runloop, _util, _owner2, _runtime, _runtime2, _browserEnvironment, _engine, _service, _object, _environment2, _container, _node, _glimmer, _globalContext, _routing2, _error, _program, _rsvp) {
    ...
    if (_deprecatedFeatures.EMBER_COMPONENT_IS_VISIBLE) {
        createStyleBindingRef = function createStyleBindingRef(inner, isVisibleRef) {
            return (0, _reference.createComputeRef)(function() {
                ...
                if (false /* DEBUG */ && isVisible !== undefined) {
    ...
    */
    ...
    var Component = _views.CoreView.extend(_views.ChildViewsSupport, _views.ViewStateSupport, _views.ClassNamesSupport, _runtime2.TargetActionSupport, _views.ActionSupport, _views.ViewMixin, (_CoreView$extend = {
        ...
        init: function init() {
            ...
            this[BOUNDS] = null;
            if (false /* DEBUG */ && this.renderer._isInteractive && this.tagName === '') {
                var eventNames = [];
    ...
    (0, _manager2.setInternalComponentManager)(CURLY_COMPONENT_MANAGER, Component); {
        ...
        Object.defineProperty(Component, 'reopen', {
            ...
            value: function reopen() {
                var _CoreObject$reopen;
                if (this === Component) {
                    (false && !(false) && (0, _debug.deprecate)('Reopening the Ember.Component super class itself is deprecated. ' + 'Consider alternatives such as installing event listeners on ' + 'the document or add the customizations to specific subclasses.', false, {
                ...
                return (_CoreObject$reopen = _runtime2.CoreObject.reopen).call.apply(_CoreObject$reopen, [this].concat(args));
            }
        });
        Object.defineProperty(Component, 'reopenClass', {
            ...
            value: function reopenClass() {
                ...
                return (_CoreObject$reopenCla = _runtime2.CoreObject.reopenClass).call.apply(_CoreObject$reopenCla, [this].concat(args));
            }
        });
    }
    ...
    */
    ...
    Checkbox.toString = function() {
        ...
        Object.defineProperty(Checkbox, 'reopen', {
            ...
            writable: true,
            value: function reopen() {
                var _FrameworkObject$reop;
                if (this === Checkbox) {
                    (false && !(false) && (0, _debug.deprecate)('Reopening Ember.Checkbox is deprecated. Consider implementing your own ' + 'wrapper component or create a custom subclass.', false, {
                ...
                return (_FrameworkObject$reop = _runtime2.FrameworkObject.reopen).call.apply(_FrameworkObject$reop, [this].concat(args));
            }
        });
        Object.defineProperty(Checkbox, 'reopenClass', {
            ...
            value: function reopenClass() {
                ...
                return (_FrameworkObject$reop2 = _runtime2.FrameworkObject.reopenClass).call.apply(_FrameworkObject$reop2, [this].concat(args));
            }
        });
    }
    ...
    */
    ...
    TextField.toString = function() {
        ...
        Object.defineProperty(TextField, 'reopen', {
            ...
            writable: true,
            value: function reopen() {
                var _CoreObject$reopen2;
                if (this === TextField) {
                    (false && !(false) && (0, _debug.deprecate)('Reopening Ember.TextField is deprecated. Consider implementing your own ' + 'wrapper component or create a custom subclass.', false, {
                        id: 'ember.built-in-components.reopen',
                        for: 'ember-source',
                        since: {
                            enabled: '3.27.0'
                ...
                return (_CoreObject$reopen2 = _runtime2.CoreObject.reopen).call.apply(_CoreObject$reopen2, [this].concat(args));
            }
        });
        Object.defineProperty(TextField, 'reopenClass', {
            ...
            value: function reopenClass() {
                ...
                return (_CoreObject$reopenCla2 = _runtime2.CoreObject.reopenClass).call.apply(_CoreObject$reopenCla2, [this].concat(args));
            }
        });
    }
    ...
    */
    ...
    TextArea.toString = function() {
        ...
        Object.defineProperty(TextArea, 'reopen', {
            ...
            writable: true,
            value: function reopen() {
                var _CoreObject$reopen3;
                if (this === TextArea) {
                    (false && !(false) && (0, _debug.deprecate)('Reopening Ember.TextArea is deprecated. Consider implementing your own ' + 'wrapper component or create a custom subclass.', false, {
                        id: 'ember.built-in-components.reopen',
                        for: 'ember-source',
                        since: {
                            enabled: '3.27.0'
                ...
                return (_CoreObject$reopen3 = _runtime2.CoreObject.reopen).call.apply(_CoreObject$reopen3, [this].concat(args));
            }
        });
        Object.defineProperty(TextArea, 'reopenClass', {
            ...
            value: function reopenClass() {
                ...
                return (_CoreObject$reopenCla3 = _runtime2.CoreObject.reopenClass).call.apply(_CoreObject$reopenCla3, [this].concat(args));
            }
        });
    }
    ...
    **/
    ...
    LinkComponent.reopenClass({
        ...
        Object.defineProperty(LinkComponent, 'reopen', {
            ...
            writable: true,
            value: function reopen() {
                var _CoreObject$reopen4;
                if (this === LinkComponent) {
                    (false && !(false) && (0, _debug.deprecate)('Reopening Ember.LinkComponent is deprecated. Consider implementing your own ' + 'wrapper component or create a custom subclass.', false, {
                        id: 'ember.built-in-components.reopen',
                        for: 'ember-source',
                        since: {
                            enabled: '3.27.0'
                ...
                return (_CoreObject$reopen4 = _runtime2.CoreObject.reopen).call.apply(_CoreObject$reopen4, [this].concat(args));
            }
        });
        Object.defineProperty(LinkComponent, 'reopenClass', {
            ...
            value: function reopenClass() {
                ...
                return (_CoreObject$reopenCla4 = _runtime2.CoreObject.reopenClass).call.apply(_CoreObject$reopenCla4, [this].concat(args));
            }
        });
    }
    ...
    var InternalModifier = /*#__PURE__*/ function() {
        function InternalModifier(owner, element, args) {
            this.owner = owner;
            this.element = element;
            this.args = args;
            (0, _owner2.setOwner)(this, owner);
        } // Override this
        InternalModifier.toString = function toString() {
            return 'internal modifier';
        };
        var _proto5 = InternalModifier.prototype;
        _proto5.install = function install() {};
        _proto5.remove = function remove() {};
        _proto5.positional = function positional(index) {
            var ref = this.args.positional[index];
            return ref ? (0, _reference.valueForRef)(ref) : undefined;
        };
        _proto5.named = function named(key) {
    ...
    var InternalModifierState = function InternalModifierState(instance) {
        this.instance = instance;
    };
    var InternalModifierManager = /*#__PURE__*/ function() {
        function InternalModifierManager(ModifierClass, name) {
            this.ModifierClass = ModifierClass;
            this.name = name;
        }
        var _proto6 = InternalModifierManager.prototype;
        _proto6.create = function create(owner, element, _definition, args) {
            (false && !(element instanceof HTMLElement) && (0, _debug.assert)('element must be an HTMLElement', element instanceof HTMLElement));
            var ModifierClass = this.ModifierClass;
        ...
        ;
        _proto6.getTag = function getTag() {
            return null;
        };
        _proto6.getDebugName = function getDebugName() {
            return this.name;
        };
        _proto6.install = function install(_ref7) {
            var instance = _ref7.instance;
            return instance.install();
        } // not needed for now, but feel free to implement this
        ;
        _proto6.update = function update() {
            (false && !(false) && (0, _debug.assert)('update should never be called on an internal modifier'));
        };
        _proto6.getDestroyable = function getDestroyable(_ref8) {
            var instance = _ref8.instance;
            return instance;
        };
        return InternalModifierManager;
    }();

    function NOOP$2() {} // TODO: remove me when IE11 support is EOL

    var ObjectEntries = function() {
    ...
    var InternalComponent = /*#__PURE__*/ function() {
         ...
         */
        ;
        var _proto7 = InternalComponent.prototype;
        _proto7.validateArguments = function validateArguments() {
        ...
        _proto7.named = function named(name) {
            var ref = this.args.named[name];
            return ref ? (0, _reference.valueForRef)(ref) : undefined;
        };
        _proto7.positional = function positional(index) {
            var ref = this.args.positional[index];
            return ref ? (0, _reference.valueForRef)(ref) : undefined;
        };
        _proto7.listenerFor = function listenerFor(name) {
        ...
        ;
        _proto7.isSupportedArgument = function isSupportedArgument(_name) {
            return false;
        } // eslint-disable-next-line @typescript-eslint/no-unused-vars
        ;
        _proto7.onUnsupportedArgument = function onUnsupportedArgument(_name) {};
    ...
    var InternalManager = /*#__PURE__*/ function() {
        ...
        var _proto8 = InternalManager.prototype;
        _proto8.getCapabilities = function getCapabilities() {
            return CAPABILITIES;
        };
        _proto8.create = function create(owner, definition, args, _env, _dynamicScope, caller) {
        ...
        _proto8.didCreate = function didCreate() {};
        _proto8.didUpdate = function didUpdate() {};
        _proto8.didRenderLayout = function didRenderLayout() {};
        _proto8.didUpdateLayout = function didUpdateLayout() {};
        _proto8.getDebugName = function getDebugName(definition) {
            return definition.toString();
        };
        _proto8.getSelf = function getSelf(instance) {
            return (0, _reference.createConstRef)(instance, 'this');
        };
        _proto8.getDestroyable = function getDestroyable(instance) {
            return instance;
        };
    ...
    function handleDeprecatedArguments(target) {
        {
            ...
            Object.defineProperty(prototype, 'onUnsupportedArgument', {
                ...
                value: function onUnsupportedArgument(name) {
                    (false && !(false) && (0, _debug.deprecate)("Passing the `@" + name + "` argument to <" + angle + "> is deprecated.", false, {
    ...
    function handleDeprecatedAttributeArguments(target, bindings) {
        {
            ...
            bindings.forEach(function(binding) {
                ...
                var superGetter = function superGetter() {
                    return undefined;
                };
                if (superDescriptor) {
                    (false && !(typeof superDescriptor.get === 'function') && (0, _debug.assert)("[BUG] expecting " + attribute + " to be a getter on <" + angle + ">", typeof superDescriptor.get === 'function'));
                ...
                Object.defineProperty(prototype, attribute, {
                    ...
                    get: function get() {
                        if (argument in this.args.named) {
                            (false && !(false) && (0, _debug.deprecate)("Passing the `@" + argument + "` argument to <" + angle + "> is deprecated. " + ("Instead, please pass the attribute directly, i.e. `<" + angle + " " + attribute + "={{...}} />` ") + ("instead of `<" + angle + " @" + argument + "={{...}} />` or `{{" + curly + " " + argument + "=...}}`."), false, {
    ...
    var handleDeprecatedEventArguments = NOOP$2; {
        ...
        var getEventsMap = function getEventsMap(owner) {
            ...
            if (events === undefined) {
                ...
                if (eventDispatcher !== null && eventDispatcher !== undefined) {
                    (false && !(typeof eventDispatcher === 'object') && (0, _debug.assert)('[BUG] invalid event dispatcher', typeof eventDispatcher === 'object'));
                    if ('_finalEvents' in eventDispatcher && eventDispatcher._finalEvents !== null && eventDispatcher._finalEvents !== undefined) {
                        (false && !(typeof eventDispatcher._finalEvents === 'object') && (0, _debug.assert)('[BUG] invalid _finalEvents on event dispatcher', typeof eventDispatcher._finalEvents === 'object'));
        ...
        handleDeprecatedEventArguments = function handleDeprecatedEventArguments(target, extraEvents) {
            ...
            Object.defineProperty(prototype, 'isSupportedArgument', {
                ...
                enumerable: false,
                value: function isSupportedArgument(name) {
                    var events = [].concat(ObjectValues(getEventsMap(this.owner)), ['focus-in', 'focus-out', 'key-press', 'key-up', 'key-down']);
                    return this.modernized && events.indexOf(name) !== -1 || superIsSupportedArgument.call(this, name);
                }
            });
            var DeprecatedEventHandlersModifier = /*#__PURE__*/ function(_InternalModifier) {
                (0, _emberBabel.inheritsLoose)(DeprecatedEventHandlersModifier, _InternalModifier);

                function DeprecatedEventHandlersModifier() {
                    var _this4;
                    _this4 = _InternalModifier.apply(this, arguments) || this;
                    _this4.listeners = new Map();
                    return _this4;
                }
                DeprecatedEventHandlersModifier.toString = function toString() {
                    return 'DeprecatedEventHandlersModifier';
                };
                var _proto9 = DeprecatedEventHandlersModifier.prototype;
                _proto9.install = function install() {
                    var element = this.element,
                        component = this.component,
                        listenerFor = this.listenerFor,
                        listeners = this.listeners;
                    var entries = [].concat(ObjectEntries(getEventsMap(this.owner)), extraEvents);
                    for (var _iterator = (0, _emberBabel.createForOfIteratorHelperLoose)(entries), _step; !(_step = _iterator()).done;) {
                ...
                _proto9.remove = function remove() {
                    var element = this.element,
                        listeners = this.listeners;
                    for (var _iterator2 = (0, _emberBabel.createForOfIteratorHelperLoose)(ObjectEntries(listeners)), _step2; !(_step2 = _iterator2()).done;) {
                ...
                _proto9.listenerFor = function listenerFor(event, argument) {
                    ...
                    if (argument in this.args.named) {
                        ...
                        (false && !(argument in this) && (0, _debug.deprecate)("Passing the `@" + argument + "` argument to <" + angle + "> is deprecated. " + ("Instead, please use the {{on}} modifier, i.e. `<" + angle + " {{on \"" + event + "\" ...}} />` ") + ("instead of `<" + angle + " @" + argument + "={{...}} />` or `{{" + curly + " " + argument + "=...}}`."), argument in this, {
                            id: 'ember.built-in-components.legacy-attribute-arguments',
                            for: 'ember-source',
                            since: {
                                enabled: '3.27.0'
                ...
                (0, _emberBabel.createClass)(DeprecatedEventHandlersModifier, [{
                    key: "component",
                    get: function get() {
                        var component = this.positional(0);
                        (false && !(component instanceof target) && (0, _debug.assert)("[BUG] must pass <" + angle + "> component as first argument", component instanceof target));
                        return component;
                    }
                }]);
                return DeprecatedEventHandlersModifier;
            ...
            Object.defineProperty(prototype, 'listenerFor', {
                ...
                value: function listenerFor(name) {
                    ...
                    if (_views.jQuery && !_views.jQueryDisabled) {
                        return function(event) {
                            return listener(new _views.jQuery.Event(event));
                        };
                    } else {
                        return listener;
                    }
    ...
    var LocalValue = /*#__PURE__*/ function() {
        ...
        var _proto10 = LocalValue.prototype;
    ...
    var UpstreamValue = /*#__PURE__*/ function() {
        ...
        var _proto11 = UpstreamValue.prototype;
    ...
    var ForkedValue = /*#__PURE__*/ function() {
        ...
        var _proto12 = ForkedValue.prototype;
        ...
        _proto12.set = function set(value) {
            (false && !(this.local) && (0, _debug.assert)('[BUG] this.local must have been initialized at this point', this.local));
    ...
    var AbstractInput = /*#__PURE__*/ function(_InternalComponent) {
        ...
        function AbstractInput() {
            var _this5;
            _this5 = _InternalComponent.apply(this, arguments) || this;
            _this5.modernized = _this5.shouldModernize();
            _this5._value = valueFrom(_this5.args.named.value);
            return _this5;
        }
        var _proto13 = AbstractInput.prototype;
        _proto13.validateArguments = function validateArguments() {
        ...
        _proto13.shouldModernize = function shouldModernize() {
            return Boolean(true
                /* EMBER_MODERNIZED_BUILT_IN_COMPONENTS */
            ) && Component._wasReopened === false && _views.TextSupport._wasReopened === false && _runtime2.TargetActionSupport._wasReopened === false;
        };
        _proto13.valueDidChange = function valueDidChange(event) {
        ...
        /* @action */
        ;
        _proto13.change = function change(event) {
            this.valueDidChange(event);
        }
        /* @action */
        ;
        _proto13.input = function input(event) {
            this.valueDidChange(event);
        };
        _proto13.keyUp = function keyUp(event) {
            switch (event.key) {
                case 'Enter':
        ...
        _proto13.listenerFor = function listenerFor(name) {
        ...
        _proto13.isVirtualEventListener = function isVirtualEventListener(name, _listener) {
    ...
    function handleDeprecatedFeatures(target, attributeBindings) {
        if (_deprecatedFeatures.SEND_ACTION) {
            var angle = target.toString();
            var prototype = target.prototype;
            var isView = function isView(target) {
            ...
            Object.defineProperty(prototype, 'listenerFor', {
                ...
                value: function listenerFor(name) {
                    ...
                    if (typeof actionName === 'string') {
                        (false && !(false) && (0, _debug.deprecate)("Passing actions to components as strings (like `<" + angle + " @" + name + "=\"" + actionName + "\" />`) is deprecated. " + ("Please use closure actions instead (`<" + angle + " @" + name + "={{action \"" + actionName + "\"}} />`)."), false, {
                        ...
                        (false && !(caller && typeof caller === 'object') && (0, _debug.assert)('[BUG] missing caller', caller && typeof caller === 'object'));
                        var listener;
                        if (isView(caller)) {
                            listener = function listener() {
                                ...
                                return caller.send.apply(caller, [actionName].concat(args));
                            };
                        } else {
                            (false && !(typeof caller[actionName] === 'function') && (0, _debug.assert)("The action '" + actionName + "' did not exist on " + caller, typeof caller[actionName] === 'function'));
                            listener = caller[actionName];
                        }
                        var deprecatedListener = function deprecatedListener() {
                            (false && !(false) && (0, _debug.deprecate)("Passing actions to components as strings (like `<" + angle + " @" + name + "=\"" + actionName + "\" />`) is deprecated. " + ("Please use closure actions instead (`<" + angle + " @" + name + "={{action \"" + actionName + "\"}} />`)."), false, {
                                id: 'ember-component.send-action',
                                for: 'ember-source',
                                since: {},
            ...
            var _prototype = target.prototype;
            var virtualEvents = {
                focusin: 'focus-in',
                focusout: 'focus-out',
                keypress: 'key-press',
    ...
    */
    var Input = /*#__PURE__*/ function(_AbstractInput) {
        ...
        function Input() {
            var _this6;
            _this6 = _AbstractInput.apply(this, arguments) || this;
            _this6._checked = valueFrom(_this6.args.named.checked);
            return _this6;
        }
        ...
        _proto14.change = function change(event) {
            if (this.isCheckbox) {
        ...
        _proto14.input = function input(event) {
            if (!this.isCheckbox) {
                _AbstractInput.prototype.input.call(this, event);
            }
        };
        _proto14.checkedDidChange = function checkedDidChange(event) {
        ...
        _proto14.shouldModernize = function shouldModernize() {
            return _AbstractInput.prototype.shouldModernize.call(this) && TextField._wasReopened === false && Checkbox._wasReopened === false;
        };
        _proto14.isSupportedArgument = function isSupportedArgument(name) {
        ...
        (0, _emberBabel.createClass)(Input, [{
            ...
            get: function get() {
                ...
                if (this.isCheckbox) {
                    (false && (0, _debug.warn)('`<Input @type="checkbox" />` reflects its checked state via the `@checked` argument. ' + 'You wrote `<Input @type="checkbox" @value={{...}} />` which is likely not what you intended. ' + 'Did you mean `<Input @type="checkbox" @checked={{...}} />`?', (0, _validator.untrack)(function() {
                        return _this7.args.named.checked !== undefined || _this7.args.named.value === undefined || typeof(0, _reference.valueForRef)(_this7.args.named.value) === 'string';
                    }), {
            ...
            set: function set(checked) {
                var _this8 = this;
                (false && (0, _debug.warn)('`<Input @type="checkbox" />` reflects its checked state via the `@checked` argument. ' + 'You wrote `<Input @type="checkbox" @value={{...}} />` which is likely not what you intended. ' + 'Did you mean `<Input @type="checkbox" @checked={{...}} />`?', (0, _validator.untrack)(function() {
                    return _this8.args.named.checked !== undefined || _this8.args.named.value === undefined || typeof(0, _reference.valueForRef)(_this8.args.named.value) === 'string';
                }), {
                    id: 'ember.built-in-components.input-checkbox-value'
                }));
    ...
    __decorate$1([_object.action], Input.prototype, "checkedDidChange", null); {
        handleDeprecatedFeatures(Input, [
            // Component
            'id', ['id', 'elementId'], 'class', ['class', 'classNames'],
            ['role', 'ariaRole'],
            // TextSupport
    ...
    */
    var Textarea = /*#__PURE__*/ function(_AbstractInput2) {
        ...
        var _proto15 = Textarea.prototype;
        // See abstract-input.ts for why these are needed
        _proto15.change = function change(event) {
            _AbstractInput2.prototype.change.call(this, event);
        };
        _proto15.input = function input(event) {
            _AbstractInput2.prototype.input.call(this, event);
        };
        _proto15.shouldModernize = function shouldModernize() {
            return _AbstractInput2.prototype.shouldModernize.call(this) && TextArea._wasReopened === false;
        };
        _proto15.isSupportedArgument = function isSupportedArgument(name) {
    ...
    */
    ...
    var ClassicHelperManager = /*#__PURE__*/ function() {
        ...
        var _proto16 = ClassicHelperManager.prototype;
        _proto16.createHelper = function createHelper(definition, args) {
        ...
        _proto16.getDestroyable = function getDestroyable(_ref9) {
            var instance = _ref9.instance;
            return instance;
        };
        _proto16.getValue = function getValue(_ref10) {
        ...
        _proto16.getDebugName = function getDebugName(definition) {
    ...
    var Wrapper = /*#__PURE__*/ function() {
        ...
        var _proto17 = Wrapper.prototype;
    ...
    var SimpleClassicHelperManager = /*#__PURE__*/ function() {
        ...
        var _proto18 = SimpleClassicHelperManager.prototype;
        _proto18.createHelper = function createHelper(definition, args) {
        ...
        _proto18.getValue = function getValue(fn$$1) {
            return fn$$1();
        };
        _proto18.getDebugName = function getDebugName(definition) {
    ...
    */
    ...
    var OutletComponentManager = /*#__PURE__*/ function() {
        ...
        var _proto19 = OutletComponentManager.prototype;
        _proto19.create = function create(_owner, definition, _args, env, dynamicScope) {
        ...
        _proto19.getDebugName = function getDebugName(_ref11) {
            var name = _ref11.name;
            return name;
        };
        _proto19.getDebugCustomRenderTree = function getDebugCustomRenderTree(definition, state, args) {
            var nodes = [];
            if (state.outlet) {
                nodes.push({
                    bucket: state.outlet,
        ...
        _proto19.getCapabilities = function getCapabilities() {
            return CAPABILITIES$1;
        };
        _proto19.getSelf = function getSelf(_ref12) {
            var self = _ref12.self;
            return self;
        };
        _proto19.didCreate = function didCreate() {};
        _proto19.didUpdate = function didUpdate() {};
        _proto19.didRenderLayout = function didRenderLayout(state) {
            state.finalize();
        };
        _proto19.didUpdateLayout = function didUpdateLayout() {};
        _proto19.getDestroyable = function getDestroyable() {
            return null;
        };
    ...
    function createRootOutlet(outletView) {
        if (_environment2.ENV._APPLICATION_TEMPLATE_WRAPPER) {
            ...
            var WrappedOutletComponentManager = /*#__PURE__*/ function(_OutletComponentManag) {
                ...
                var _proto20 = WrappedOutletComponentManager.prototype;
                _proto20.getTagName = function getTagName() {
                    return 'div';
                };
                _proto20.getCapabilities = function getCapabilities() {
                    return WRAPPED_CAPABILITIES;
                };
                _proto20.didCreateElement = function didCreateElement(component, element) {
    ...
    var RootComponentManager = /*#__PURE__*/ function(_CurlyComponentManage) {
        ...
        var _proto21 = RootComponentManager.prototype;
        _proto21.create = function create(_owner, _state, _args, _ref13, dynamicScope) {
            var isInteractive = _ref13.isInteractive;
            var component = this.component;
    ...
    */
    ...
    var eachIn = internalHelper(function(_ref14) {
    ...
    var BoundedIterator = /*#__PURE__*/ function() {
        ...
        var _proto22 = BoundedIterator.prototype;
    ...
    var ArrayIterator = /*#__PURE__*/ function(_BoundedIterator) {
        ...
        var _proto23 = ArrayIterator.prototype;
    ...
    var EmberArrayIterator = /*#__PURE__*/ function(_BoundedIterator2) {
        ...
        var _proto24 = EmberArrayIterator.prototype;
        _proto24.valueFor = function valueFor(position) {
    ...
    var ObjectIterator = /*#__PURE__*/ function(_BoundedIterator3) {
        ...
        var _proto25 = ObjectIterator.prototype;
        _proto25.valueFor = function valueFor(position) {
            return this.values[position];
        };
        _proto25.memoFor = function memoFor(position) {
    ...
    var NativeIterator = /*#__PURE__*/ function() {
        ...
        var _proto26 = NativeIterator.prototype;
        _proto26.isEmpty = function isEmpty() {
            return false;
        };
    ...
    var ArrayLikeNativeIterator = /*#__PURE__*/ function(_NativeIterator) {
        ...
        var _proto27 = ArrayLikeNativeIterator.prototype;
        _proto27.valueFor = function valueFor(result) {
            return result.value;
        };
        _proto27.memoFor = function memoFor(_result, position) {
            return position;
        };
    ...
    var MapLikeNativeIterator = /*#__PURE__*/ function(_NativeIterator2) {
        ...
        var _proto28 = MapLikeNativeIterator.prototype;
        _proto28.valueFor = function valueFor(result) {
            return result.value[1];
        };
        _proto28.memoFor = function memoFor(result) {
    ...
    var EmberEnvironmentDelegate = /*#__PURE__*/ function() {
        ...
        var _proto29 = EmberEnvironmentDelegate.prototype;
        _proto29.onTransactionCommit = function onTransactionCommit() {};
        return EmberEnvironmentDelegate;
    }();
    /**
    @module ember
    */
    var disallowDynamicResolution = internalHelper(function(_ref15) {
        ...
        (false && !(typeof loc$$1 === 'string') && (0, _debug.assert)('[BUG] expecting a string literal for the `loc` argument', typeof loc$$1 === 'string'));
    ...
    var normalizeClassHelper = internalHelper(function(_ref16) {
    ...
    var resolve = internalHelper(function(_ref17, owner) {
    ...
    */
    ...
    var trackArray = internalHelper(function(_ref18) {
    ...
    */
    ...
    var mut = internalHelper(function(_ref19) {
    ...
    */
    ...
    var queryParams = internalHelper(function(_ref20) {
    ...
    */
    ...
    var readonly = internalHelper(function(_ref21) {
    ...
    */
    ...
    var unbound = internalHelper(function(_ref22) {
    ...
    var ActionState = /*#__PURE__*/ function() {
        ...
        var _proto30 = ActionState.prototype;
        _proto30.getEventName = function getEventName() {
            var on$$1 = this.namedArgs.on;
            return on$$1 !== undefined ? (0, _reference.valueForRef)(on$$1) : 'click';
        };
        _proto30.getActionArgs = function getActionArgs() {
        ...
        _proto30.getTarget = function getTarget() {
        ...
        _proto30.handler = function handler(event) {
            var _this15 = this;
    ...
    var ActionModifierManager = /*#__PURE__*/ function() {
        ...
        var _proto31 = ActionModifierManager.prototype;
        _proto31.create = function create(_owner, element, _state, _ref23) {
            var named = _ref23.named,
                positional = _ref23.positional;
        ...
        _proto31.getDebugName = function getDebugName() {
            return 'action';
        };
        _proto31.install = function install(actionState) {
        ...
        _proto31.update = function update(actionState) {
        ...
        _proto31.getTag = function getTag(actionState) {
            return actionState.tag;
        };
        _proto31.getDestroyable = function getDestroyable(actionState) {
            return actionState;
        };
    ...
    var MountManager = /*#__PURE__*/ function() {
        ...
        var _proto32 = MountManager.prototype;
        _proto32.getDynamicLayout = function getDynamicLayout(state) {
        ...
        _proto32.getOwner = function getOwner(state) {
            return state.engine;
        };
        _proto32.create = function create(owner, _ref24, args, env) {
        ...
        _proto32.getDebugName = function getDebugName(_ref25) {
            var name = _ref25.name;
            return name;
        };
        _proto32.getDebugCustomRenderTree = function getDebugCustomRenderTree(definition, state, args, templateModuleName) {
            return [{
                bucket: state.engine,
                instance: state.engine,
                type: 'engine',
        ...
        _proto32.getSelf = function getSelf(_ref26) {
            var self = _ref26.self;
            return self;
        };
        _proto32.getDestroyable = function getDestroyable(bucket) {
            return bucket.engine;
        };
        _proto32.didCreate = function didCreate() {};
        _proto32.didUpdate = function didUpdate() {};
        _proto32.didRenderLayout = function didRenderLayout() {};
        _proto32.didUpdateLayout = function didUpdateLayout() {};
        _proto32.update = function update(bucket) {
    ...
    */
    ...
    var ResolverImpl = /*#__PURE__*/ function() {
        ...
        var _proto33 = ResolverImpl.prototype;
        _proto33.lookupPartial = function lookupPartial(name, owner) {
            if (_deprecatedFeatures.PARTIALS) {
        ...
        _proto33.lookupHelper = function lookupHelper(name, owner) {
        ...
        _proto33.lookupBuiltInHelper = function lookupBuiltInHelper(name) {
            var _a;
            return (_a = BUILTIN_KEYWORD_HELPERS[name]) !== null && _a !== void 0 ? _a : null;
        };
        _proto33.lookupModifier = function lookupModifier(name, owner) {
        ...
        _proto33.lookupBuiltInModifier = function lookupBuiltInModifier(name) {
            var _a;
            return (_a = BUILTIN_KEYWORD_MODIFIERS[name]) !== null && _a !== void 0 ? _a : null;
        };
        _proto33.lookupComponent = function lookupComponent(name, owner) {
    ...
    var DynamicScope = /*#__PURE__*/ function() {
        ...
        var _proto34 = DynamicScope.prototype;
        _proto34.child = function child() {
        ...
        _proto34.set = function set(key, value) {
            // tslint:disable-next-line:max-line-length
    ...
    var RootState = /*#__PURE__*/ function() {
        ...
        var _proto35 = RootState.prototype;
        _proto35.isFor = function isFor(possibleRoot) {
    ...
    */
    ...
    var Renderer = /*#__PURE__*/ function() {
        ...
        var _proto36 = Renderer.prototype;
        // renderer HOOKS
        _proto36.appendOutletView = function appendOutletView(view, target) {
            var definition = createRootOutlet(view);
            this._appendDefinition(view, (0, _runtime.curry)(0
                /* Component */
                , definition, view.owner, null, true), target);
        };
        _proto36.appendTo = function appendTo(view, target) {
            var definition = new RootComponentDefinition(view);
            this._appendDefinition(view, (0, _runtime.curry)(0
                /* Component */
                , definition, this._owner, null, true), target);
        };
        _proto36._appendDefinition = function _appendDefinition(root, definition, target) {
        ...
        _proto36.rerender = function rerender() {
            this._scheduleRevalidate();
        };
        _proto36.register = function register(view) {
        ...
        _proto36.unregister = function unregister(view) {
            delete this._viewRegistry[(0, _views.getViewId)(view)];
        };
        _proto36.remove = function remove(view) {
        ...
        _proto36.cleanupRootFor = function cleanupRootFor(view) {
        ...
        _proto36.getElement = function getElement(view) {
            if (this._isInteractive) {
        ...
        _proto36.getBounds = function getBounds(view) {
        ...
        _proto36.createElement = function createElement(tagName) {
            return this._runtime.env.getAppendOperations().createElement(tagName);
        };
        _proto36._renderRoot = function _renderRoot(root) {
        ...
        _proto36._renderRoots = function _renderRoots() {
            var _this17 = this;
            var roots = this._roots,
        ...
        _proto36._renderRootsTransaction = function _renderRootsTransaction() {
        ...
        _proto36._clearAllRoots = function _clearAllRoots() {
            var roots = this._roots;
            for (var i = 0; i < roots.length; i++) {
                var root = roots[i];
                root.destroy();
    ...
    var LinkTo = /*#__PURE__*/ function(_InternalComponent2) {
        ...
        function LinkTo() {
            var _this18;
            _this18 = _InternalComponent2.apply(this, arguments) || this;
            _this18.modernized = _this18.shouldModernize(); // GH #17963

            _this18.currentRouteCache = (0, _validator.createCache)(function() {
                (0, _validator.consumeTag)((0, _validator.tagFor)(_this18.routing, 'currentState'));
                return (0, _validator.untrack)(function() {
                    return _this18.routing.currentRouteName;
                });
            });
            return _this18;
        }
        ...
        _proto37.click = function click(event) {
            if (!(0, _views.isSimpleClick)(event)) {
                return;
            }
        ...
        _proto37.classFor = function classFor(state) {
        ...
        _proto37.namespaceRoute = function namespaceRoute(route) {
        ...
        _proto37.isActiveForState = function isActiveForState(state) {
            var _this19 = this;
            if (!isPresent(state)) {
                return false;
            }
            ...
            if (typeof currentWhen === 'boolean') {
                ...
                return currentWhen.split(' ').some(function(route) {
                    return routing.isActiveForRoute(models, undefined, _this19.namespaceRoute(route), state);
                });
            } else {
                var route = this.route,
                    _models = this.models,
        ...
        _proto37.preventDefault = function preventDefault(event) {
            event.preventDefault();
        };
        _proto37.shouldModernize = function shouldModernize() {
            return Boolean(true
                /* EMBER_MODERNIZED_BUILT_IN_COMPONENTS */
            ) && Component._wasReopened === false && _runtime2.TargetActionSupport._wasReopened === false && LinkComponent._wasReopened === false;
        };
        _proto37.isSupportedArgument = function isSupportedArgument(name) {
...

    {
...

        {
            ...
            Object.defineProperty(prototype, 'isSupportedArgument', {
                ...
                value: function isSupportedArgument(name) {
                    if (this.modernized) {
                        if (name === 'bubbles') {
                            (false && !(false) && (0, _debug.deprecate)('Passing the `@bubbles` argument to <LinkTo> is deprecated. ' + 'Use the {{on}} modifier to attach a custom event handler to ' + 'control event propagation.', false, {
                                id: 'ember.built-in-components.legacy-arguments',
                                for: 'ember-source',
                                since: {
                                    enabled: '3.27.0'
                        ...
                        if (name === 'preventDefault') {
                            (false && !(false) && (0, _debug.deprecate)('Passing the `@preventDefault` argument to <LinkTo> is deprecated. ' + '`preventDefault()` is called automatically on events that are ' + 'handled by the <LinkTo> component to prevent the browser from ' + 'navigating away from the page.', false, {
                                id: 'ember.built-in-components.legacy-arguments',
                                for: 'ember-source',
                                since: {
                                    enabled: '3.27.0'
                ...
                value: function preventDefault(event) {
                    ...
                    if ('preventDefault' in this.args.named) {
                        ...
                        if (isMissing(value) || value) {
                            ...
                            (false && !(false) && (0, _debug.deprecate)('Passing the `@preventDefault` argument to <LinkTo> is deprecated. ' + '`preventDefault()` should always be called on events that are ' + 'handled by the <LinkTo> component to prevent the browser from ' + 'navigating away from the page.', false, {
                                id: 'ember.built-in-components.legacy-arguments',
                                for: 'ember-source',
                                since: {
                                    enabled: '3.27.0'
                    ...
                    if ('bubbles' in this.args.named) {
                        ...
                        if (_value === false) {
                            ...
                            (false && !(false) && (0, _debug.deprecate)('Passing the `@bubbles` argument to <LinkTo> is deprecated. ' + '`stopPropagation()` is not automatically called so there is ' + 'no need to pass this argument when you DO want the event to ' + 'propagate normally', false, {
                                id: 'ember.built-in-components.legacy-arguments',
                                for: 'ember-source',
                                since: {
                                    enabled: '3.27.0'
...

        {
                ...
                value: function isSupportedArgument(name) {
                    if (this.modernized) {
                        if (name === 'disabledWhen') {
                            (false && !(false) && (0, _debug.deprecate)('Passing the `@disabledWhen` argument to <LinkTo> is deprecated. ' + 'Use the `@disabled` argument instead.', false, {
            ...
            (false && !(superDescriptor && typeof superDescriptor.get === 'function') && (0, _debug.assert)("[BUG] expecting isDisabled to be a getter on <LinkTo>", superDescriptor && typeof superDescriptor.get === 'function'));
    ...
    */
    ...
    var OutletView = /*#__PURE__*/ function() {
        ...
        var _proto38 = OutletView.prototype;
        _proto38.appendTo = function appendTo(selector) {
            var target;
        ...
        _proto38.rerender = function rerender() {
            /**/
        };
        _proto38.setOutletState = function setOutletState(state) {
    ...
    function setupApplicationRegistry(registry) {
        ...
        registry.register('service:-dom-builder', {
            create: function create(_ref27) {
                var bootOptions = _ref27.bootOptions;
