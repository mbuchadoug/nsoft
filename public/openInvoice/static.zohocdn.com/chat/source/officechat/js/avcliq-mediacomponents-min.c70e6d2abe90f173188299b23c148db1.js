...
WebRTCUserMedia = function() {
    var e = void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia,
        ...
        a = e && void 0 !== window.RTCRtpTransceiver && "function" == typeof window.RTCRtpTransceiver.prototype.setCodecPreferences;
    if (!e) return {
    ...
    var s = {};
    navigator.mediaDevices.getSupportedConstraints && (s = navigator.mediaDevices.getSupportedConstraints());
    var o = {},
        r = {
            1: null,
            2: null,
        ...
        p = function(e, t) {
            return o[e] ? o[e][t] : void 0
        },
        f = function(e, t) {
            var i = t._getType();
            void 0 === o[e] && (o[e] = {}), o[e][i] = t
        },
        m = function(e, t) {
            var i = {};
            return t !== d.AUDIO_ONLY && t !== d.AUDIO_VIDEO || !e._isPrimaryAudioTrackMuted() || (i.name = u.BadAudioTrackError), i
        },
        v = function(e, t, i, n, a, s, o, c, l) {
            var u = o ? p(c, e) : r[e];
            if (u) t(u);
            else {
                var v = M(e, n);
                (a ? navigator.mediaDevices.getDisplayMedia : navigator.mediaDevices.getUserMedia).call(navigator.mediaDevices, v).then((function(n) {
                    function a(e, t) {
                        t._isModuleInstance() ? I(t._getModuleInstanceId(), t._getType()) : S(t._getType()), "function" == typeof i && i(e, t._getType())
                    }
                    var u = o && c;
                    u && n._setAsModuleInstance(c), n._setType(e), C(n, l, (function(i) {
                        if (i._setType(e), u ? (i._setAsModuleInstance(c), f(c, i)) : r[e] = i, d.SCREEN === e) {
                            if ("function" == typeof s) {
                                var n = i._getPrimaryVideoTrack();
                                n && (n.onended = s)
                            }
                        } else if (void 0 !== MediaHandler) {
                            var o = i._hasSourceAudioStream() ? i._getSourceAudioStream()._getPrimaryAudioTrack() : i._getPrimaryAudioTrack();
                            o && (o.onended = function(e) {
                        ...
                        var p = m(i, e);
                        $WC.Util.isEmptyObject(p) ? t(i) : a(p, i)
                    }), a)
                })).catch((function(t) {
        ...
        I = function(e, t) {
            var i = p(e, t);
            i && (i._close(), delete o[e][t])
        },
        S = function(e) {
            var t = r[e];
            t ? (t._close(), r[e] = null) : r[e] = null
        },
        M = function(e, t) {
            var i = {},
                n = !0,
                a = !0;
            if (e !== d.SCREEN && s["deviceId"] && void 0 !== ZCMediaDevices) {
                var o = ZCMediaDevices.getPreferredDevices(),
                    r = o[ZCMediaDevices.kinds.AUDIO_INPUT],
    ...
    return navigator.mediaDevices.enumerateDevices ? (g(), {
        streamTypes: d,
        errors: u,
        streamInstanceIds: {
        ...
        createStreamFromCanvas: function(e, t) {
            var i = WebRTCUserMedia.streamTypes.SCREEN,
                n = e.captureStream(t);
            return n._setType(i), null !== r[i] && r[i]._close(), r[i] = n, n
        },
        isSupported: function() {
            return e
        },
        ...
        getAudioPermission: function(e, t) {
            h(ZCMediaConstants.mediaDevices.MICROPHONE, e, t)
        },
        getVideoPermission: function(e, t) {
            h(ZCMediaConstants.mediaDevices.CAMERA, e, t)
        },
        requestAudioStream: function(e, t, i, n) {
            v(this.streamTypes.AUDIO_ONLY, e, t, i, !1, void 0, !1, void 0, n)
        },
        requestVideoStream: function(e, t, i, n) {
            v(this.streamTypes.VIDEO_ONLY, e, t, i, !1, void 0, !1, void 0, n)
        },
        requestAudioVideoStream: function(e, t, i, n) {
            v(this.streamTypes.AUDIO_VIDEO, e, t, i, !1, void 0, !1, void 0, n)
        },
        requestAudioVideoOrAudioStream: function(e, t, i) {
            var n = function(n, a) {
                n.name !== this.errors.NotAllowedError ? v(this.streamTypes.AUDIO_ONLY, e, t, i, !1, void 0, !1, void 0) : "function" == typeof t && t(n, a)
            }.bind(this);
            v(this.streamTypes.AUDIO_VIDEO, e, n, i, !1, void 0, !1, void 0)
        },
        requestScreenStream: function(e, t, i, n, a, s, o) {
            ...
            if (r || $ZCUtil.Browser.isSafari() || $ZCUtil.Browser.isOpera())
                if (this.isScreenShareSupportedInNative()) {
                    ...
                    o && r ? (d.audio = !0, n && n.audio && (d.audio = n.audio)) : n && (n.audio = !1), v(this.streamTypes.SCREEN, e, t, ZCJQuery.extend(!0, {}, n, d), !0, i, a, s)
                    ...
                    }), v(this.streamTypes.SCREEN, e, t, ZCJQuery.extend(!0, {}, n, d), !1, i, a, s)
                }.bind(this), o);
            else {
                v(this.streamTypes.SCREEN, e, t, ZCJQuery.extend(!0, {}, n, {
                    audio: !1,
                    video: {
                        mediaSource: "screen"
                    }
        ...
        requestAndAddTrackInStream: function(e, t, i, n, a) {
            ...
            if (!this.isScreenStreamType(s))
                if (this.isAudioStreamType(t)) {
                    var o = e._hasVideoTrack() ? this.streamTypes.AUDIO_VIDEO : this.streamTypes.AUDIO_ONLY;
                    if (!e._hasAudioTrack() && null === r[o]) {
                        var d = null === r[this.streamTypes.AUDIO_ONLY],
                            c = function(t) {
                                e._addPrimaryAudioTrack(t._getPrimaryAudioTrack(), o), t._hasSourceAudioStream() && e._setSourceAudioStream(t._getSourceAudioStream()), r[o] = e, r[s] = null, d && (r[this.streamTypes.AUDIO_ONLY] = null), "function" == typeof i && i(e)
                            }.bind(this);
                        this.requestAudioStream(c, n, void 0, a)
                    }
                } else if (this.isVideoStreamType(t)) {
                o = e._hasAudioTrack() ? this.streamTypes.AUDIO_VIDEO : this.streamTypes.VIDEO_ONLY;
                if (!e._hasVideoTrack() && null === r[o]) {
                    d = null === r[this.streamTypes.VIDEO_ONLY], c = function(t) {
                        e._addPrimaryVideoTrack(t._getPrimaryVideoTrack(), o), t._hasBackgroundProcessor() && (e._setBackgroundProcessor(t._backgroundProcessor), e._setSourceVideoStream(t._getSourceVideoStream())), r[o] = e, r[s] = null, d && (r[this.streamTypes.VIDEO_ONLY] = null), "function" == typeof i && i(e)
                    }.bind(this);
        ...
        requestAndReplaceTracksInStream: function(e, t, i, n, a, s) {
            ...
            if (this.isAudioVideoStreamType(t)) e._hasAudioTrack() && e._hasVideoTrack() && (this.closeStream(e._getType(), !0), this.requestAudioVideoStream(o, n, a, s));
            else if (this.isAudioStreamType(t)) {
                if (e._hasAudioTrack())
                    if (e._hasVideoTrack()) {
                        var d = null === r[this.streamTypes.AUDIO_ONLY],
                            c = function(t) {
                                e._replacePrimaryAudioTrack(t._getPrimaryAudioTrack()), t._hasSourceAudioStream() && e._setSourceAudioStream(t._getSourceAudioStream()), d && (r[this.streamTypes.AUDIO_ONLY] = null), "function" == typeof i && i(e)
                            }.bind(this);
                        this.requestAudioStream(c, n, a, s)
                    } else this.closeStream(e._getType(), !0), this.requestAudioStream(o, n, a, s)
            } else if (this.isVideoStreamType(t) && e._hasVideoTrack())
                if (e._hasAudioTrack()) {
                    d = null === r[this.streamTypes.VIDEO_ONLY], c = function(t) {
                        e._replacePrimaryVideoTrack(t._getPrimaryVideoTrack()), t._hasBackgroundProcessor() && (e._setBackgroundProcessor(t._backgroundProcessor), e._setSourceVideoStream(t._getSourceVideoStream())), d && (r[this.streamTypes.VIDEO_ONLY] = null), "function" == typeof i && i(e)
                    }.bind(this);
                    this.requestVideoStream(c, n, a, s)
                } else this.closeStream(e._getType(), !0), this.requestVideoStream(o, n, a, s)
        },
        removeTracksInStream: function(e, t, i, n) {
            var a = e._getType();
            this.isAudioVideoStreamType(a) ? (this.isAudioStreamType(t) ? (e._removePrimaryAudioTrack(), e._setType(this.streamTypes.VIDEO_ONLY), r[this.streamTypes.VIDEO_ONLY] = e, r[a] = null) : this.isVideoStreamType(t) && (e._removePrimaryVideoTrack(), e._setType(this.streamTypes.AUDIO_ONLY), r[this.streamTypes.AUDIO_ONLY] = e, r[a] = null), "function" == typeof i && i(e)) : "function" == typeof n && n()
        },
        splitTracksInStream: function(e) {
            if (e && e._hasAudioTrack() && e._hasVideoTrack()) {
                var t = e._getType(),
                    i = void 0,
                    n = void 0;
                return i = new MediaStream([e._getPrimaryAudioTrack()]), e._hasSourceAudioStream() && i._setSourceAudioStream(e._getSourceAudioStream()), i._setType(this.streamTypes.AUDIO_ONLY), i._setConnectionRestrictionStatus(e), r[this.streamTypes.AUDIO_ONLY] = i, n = new MediaStream([e._getPrimaryVideoTrack()]), e._hasBackgroundProcessor() && (n._setBackgroundProcessor(e._backgroundProcessor), n._setSourceVideoStream(e._getSourceVideoStream())), n._setType(this.streamTypes.VIDEO_ONLY), n._setConnectionRestrictionStatus(e), r[this.streamTypes.VIDEO_ONLY] = n, r[t] = null, {
                    audioStream: i,
                    videoStream: n
                }
            }
        ...
        updateAndGetProcessedStream: function(e, t) {
            return function(e, t) {
                ...
                if (a._setBackgroundProcessor(t), a._setSourceVideoStream(e), a._setType(n), e._hasSourceAudioStream() && a._setSourceAudioStream(e._getSourceAudioStream()), a._setConnectionRestrictionStatus(e), e._isModuleInstance()) {
                    ...
                    a._setAsModuleInstance(s), f(s, a)
                } else r[n] = a;
                return a
            }(e, t)
        },
        ...
        Codecs: {
            ...
            isSetCodecPreferenceSupported: () => a,
            canEncodeRED: function() {
                if ("function" == typeof RTCRtpSender.getCapabilities) {
                    let e = RTCRtpSender.getCapabilities("audio");
                    if (e && e.codecs)
                        for (let t = 0; t < e.codecs.length; t++)
                            if (e.codecs[t].mimeType === WebRTCUserMedia.Codecs.TYPE.REDCodec) return !0
                }
                return !1
            },
            getUpdatedAudioCodecList: function(e) {
                if ("function" == typeof RTCRtpSender.getCapabilities) {
                    let t = RTCRtpSender.getCapabilities("audio");
                    if (t && t.codecs) {
                        let i = t.codecs,
                            n = i.findIndex(t => t.mimeType == e),
                            a = i[n];
                        return i.splice(n, 1), i.unshift(a), i
                    }
                }
            }
        }
...
ZCMediaConstants = {
    ...
    getGroupCallRecordingSettingsHtml: function(e) {
        var t = SecurityManager.getModuleConfig("group_call_recording", "allowed_group_call_recording"),
            ...
            n = "";
        $WC.Util.isEmpty(t) || ("general" === t.selected_configuration ? n = "media.recording.settings.note." + t.general_configuration : "advanced" === t.selected_configuration && (n = "media.recording.settings.note.advanced")), ($WC.Util.isEmpty(n) || "media.recording.settings.note.user_choice" === n) && (n = MediaUtil.getResource("cc.host.setting1") + " " + MediaUtil.getResource("cc.host.setting2"));
    ...
    showLiveTrackingNotification: function(e, t, i) {
        ...
        ZCJQuery("#avcliq_live_tracking_info").remove(), n.html(MediaTemplates.getLiveTrackingAlertInfo(e, t)).removeClass("zc-av-dN"), clearTimeout(MediaUtil.liveTrackingNotificationTimeout), "function" == typeof i && (MediaUtil.liveTrackingNotificationTimeout = setTimeout(i, MediaUtil.liveTrackingNotificationTimeoutDuration))
    },
...
(ZCAVCallManager = function(e) {
    ...
    isDirectCallREDCodecEnabled: function() {
        return void 0 !== this.FeatureConfig && this.FeatureConfig.isDirectCallREDCodecEnabled
    },
...
window._isZCDesktopApp = function() {
    ...
    return {
        ...
        isREDCodecEnabled: function() {
            return void 0 !== this.BRIDGE && this.BRIDGE.isDirectCallREDCodecEnabled()
        },
