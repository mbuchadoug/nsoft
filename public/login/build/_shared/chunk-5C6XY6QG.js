...
var K = G((U, F) => {
    (function(T, g) {
        typeof U == "object" && typeof F < "u" ? F.exports = g() : typeof define == "function" && define.amd ? define(g) : (T = typeof globalThis < "u" ? globalThis : T || self).dayjs = g()
    })(U, function() {
        "use strict";
        var T = 1e3,
            g = 6e4,
        ...
        var C = function() {
                function i(t) {
                    this.$L = x(t.locale, null, !0), this.parse(t), this.$x = this.$x || t.x || {}, this[V] = !0
                }
                var n = i.prototype;
                return n.parse = function(t) {
                    ...
                    var e, s = a.p(t),
                        u = "set" + (this.$u ? "UTC" : ""),
                        o = (e = {}, e[m] = u + "Date", e[_] = u + "Date", e[M] = u + "Month", e[y] = u + "FullYear", e[b] = u + "Hours", e[O] = u + "Minutes", e[w] = u + "Seconds", e[A] = u + "Milliseconds", e)[s],
                        c = s === m ? this.$D + (r - this.$W) : r;
                    if (s === M || s === y) {
                    ...
                    if (u === m) return o(1);
                    if (u === W) return o(7);
                    var c = (e = {}, e[O] = g, e[b] = J, e[w] = T, e)[u] || 1,
                        h = this.$d.getTime() + t * c;
                    return a.w(h, this)
                    ...
                    var s = t || "YYYY-MM-DDTHH:mm:ssZ",
                        ...
                        p = k || function($, v, L) {
                            var j = $ < 12 ? "AM" : "PM";
                            return L ? j.toLowerCase() : j
                        };
                    return s.replace(E, function($, v) {
                        return v || function(L) {
                            switch (L) {
                                case "YY":
                                ...
                                case "d":
                                    return String(r.$W);
                                case "dd":
                                    return S(e.weekdaysMin, r.$W, d, 2);
                                case "ddd":
                                    return S(e.weekdaysShort, r.$W, d, 3);
                                case "dddd":
                                    return d[r.$W];
                                case "H":
                                    return String(o);
                    ...
                    var s, u = this,
                        o = a.p(r),
                        c = f(t),
                        h = (c.utcOffset() - this.utcOffset()) * g,
                        d = this - c,
                        l = function() {
                            return a.m(u, c)
                        };
        ...
        return f.prototype = q, [
            ...
            return i.$i || (i(n, C, f), i.$i = !0), f
        }, f.locale = x, f.isDayjs = N, f.unix = function(i) {
            return f(1e3 * i)
        }, f.en = D[Y], f.Ls = D, f.p = {}, f
    })
});
export {
    K as a
