define("@ember/-internals/routing/lib/system/route", ["exports", "@ember/polyfills", "ember-babel", "@ember/-internals/container", "@ember/-internals/metal", "@ember/-internals/owner", "@ember/-internals/runtime", "@ember/-internals/utils", "@ember/debug", "@ember/deprecated-features", "@ember/object/compat", "@ember/runloop", "router_js", "@ember/-internals/routing/lib/utils", "@ember/-internals/routing/lib/system/generate_controller"], function(_exports, _polyfills, _emberBabel, _container, _metal, _owner, _runtime, _utils, _debug, _deprecatedFeatures, _compat, _runloop, _router_js, _utils2, _generate_controller) {
    "use strict";
    ...
    var Route = /*#__PURE__*/ function(_EmberObject) {
        ...
        */
        ...
        _proto.setup = function setup(context, transition) {
            ...
            if (this._environment.options.shouldRender) {
                (false && !(this.renderTemplate === Route.prototype.renderTemplate) && (0, _debug.deprecate)('Usage of `renderTemplate` is deprecated.', this.renderTemplate === Route.prototype.renderTemplate, {
        ...
        */
        ...
        _proto.render = function render(name, options) {
            (false && !(false) && (0, _debug.deprecate)("Usage of `render` is deprecated. Route: `" + this.routeName + "`", false, {
                id: 'route-render-template',
                until: '4.0.0',
                url: 'https://deprecations.emberjs.com/v3.x/#toc_route-render-template',
                for: 'ember-source',
        ...
        */
        ...
        _proto.disconnectOutlet = function disconnectOutlet(options) {
            (false && !(false) && (0, _debug.deprecate)('The usage of `disconnectOutlet` is deprecated.', false, {
        ...
        */
        store: (0, _metal.computed)({
            ...
            set: function set(key, value) {
                if (false /* DEBUG */ && (_container.deprecatedStoreInjections === null || _container.deprecatedStoreInjections === void 0 ? void 0 : _container.deprecatedStoreInjections.has(value))) {
                    Object.defineProperty(this, key, {
                        configurable: true,
                        enumerable: false,
                        get: function get() {
                            (false && !(false) && (0, _debug.deprecate)("A value for the `store` property was injected onto a route via the owner API. Implicit injection via the owner API is now deprecated, please add an explicit injection for this value. If the injected value is a service, consider using the @service decorator.", false, {
