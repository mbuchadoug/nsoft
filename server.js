...
var indexRouteX4= require('./routes/quality')
var indexRouteX5= require('./routes/production')
var indexRouteX6= require('./routes/rm2')
...
app.use('/quality', indexRouteX4);
app.use('/production', indexRouteX5);
app.use('/rm2', indexRouteX6);
