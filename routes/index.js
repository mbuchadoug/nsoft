...
router.post('/send-notification', async (req, res) => {
  ...
  //var token = 'crgbFGc4T9vSRU8rY3IwOy:APA91bG0vaEGnPCUZdGb1qxruWibkaO1ro1GeWPQQMJDhEUwdqBEwSICBr4lolAWFdOgGjNfQsdDW3iz7cNda8-aARyWnjVhx5MndrHIey64IpZdLx7BT4M'
...
const registrationToken ='dFKOKwR9DtAJcsSgv0CeN0:APA91bEDRHKvE-locy0bAmYPO3SJgHuIGP9U2wrQ2YMI6K4bDBr2DwrKtBxkqs-BOP0DFtTQP6C_BSeoA5p66lrzVjdqy5aVhXAKsSBOYIhhIRcH5wSQ4Tk'

  //const registrationToken = 'foJ4-Leh2t780BuosVi7_M:APA91bEau8haAbUfLgVLtGoBB3QYWUp-bYBCC1hHlxh1rx4KIZqRZoXcyq5u73vYhy-_Iu9HxQZ2UCrpSzxTmLpov-8gZ8k0TguDi8cDqSIiPLdEyeuW13M';
 //const registrationToken ='foJ4-Leh2t780BuosVi7_M:APA91bEau8haAbUfLgVLtGoBB3QYWUp-bYBCC1hHlxh1rx4KIZqRZoXcyq5u73vYhy-_Iu9HxQZ2UCrpSzxTmLpov-8gZ8k0TguDi8cDqSIiPLdEyeuW13M'
const message = {
  data: {
    score: '850',
...
StockV.find({pallet:6,refNumber:"12212024S1B2R",status:"dispatched",salesPerson:"Mama Gloria"},function(err,docs){
  for(var i = 0;i<docs.length;i++){
    let id = docs[i]._id
    StockV.findByIdAndUpdate(id,{$set:{status:"dispatched",salesPerson:"Mama Gloria",timeOfDispatch:"19:07",dispatcher:"Gloria",dispatchStatus:"dispatched",mformatDispatch:"12/21/2024",refNumDispatch:"12222024B6D12212024S1B2R"}},function(err,rocs){
...
router.get('/fona2',function(req,res){
  StockV.find({pallet:8,refNumber:"12212024S1B2R",status:"dispatched",salesPerson:"Mama Gloria"},function(err,docs){
    for(var i = 0;i<docs.length;i++){
      let id = docs[i]._id
      StockV.findByIdAndUpdate(id,{$set:{status:"dispatched",salesPerson:"Mama Gloria",timeOfDispatch:"19:07",dispatcher:"Gloria",dispatchStatus:"dispatched",mformatDispatch:"12/21/2024",refNumDispatch:"12222024B6D12212024S1B2R"}},function(err,rocs){
...
router.get('/fona3',function(req,res){
  StockV.find({pallet:10,refNumber:"12212024S1B2R",status:"dispatched",salesPerson:"Mama Gloria"},function(err,docs){
    for(var i = 0;i<20;i++){
      let id = docs[i]._id
  ...
  router.get('/fona9',function(req,res){
...
router.get('/updateStock777',function(req,res){
...
router.get('/updateSalesStockB2',isLoggedIn,function(req,res){
  
  SalesList.find({salesPerson:"mutare"},function(err,docs){
    for(var i = 0;i<docs.length;i++){
   let  salesPerson = docs[i].salesPerson
